...
module.exports.getMulticastAssistRouter = (loopback: boolean = false) => {
  active = true;
  ...
  router.get('/api/1.0/multicast-assist', async (req: express$Request, res: express$Response) => {
    res.json({ version: pkg.version });
  });

  router.ws('/api/1.0/multicast-assist/:multicastAddress/:port/:controlPort', async (ws:Object, req: express$Request) => {
    if (!active) {
    ...
    const handleReceiverData = (data:Buffer) => {
