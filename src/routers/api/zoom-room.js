...
module.exports = () => {
  ...
  router.post('/zconfiguration.audio.input.selectedID', async (req: express$Request, res: express$Response) => {
    if (!zrcs) {
      return res.status(400).send('Zoom Room Control System is not connected');
    }
  ...
  router.post('/zconfiguration.audio.input.is_sap_disabled', async (req: express$Request, res: express$Response) => {
    if (!zrcs) {
      return res.status(400).send('Zoom Room Control System is not connected');
    }
    const { body: { value } } = req;
  ...
  router.post('/zconfiguration.audio.input.reduce_reverb', async (req: express$Request, res: express$Response) => {
    if (!zrcs) {
      return res.status(400).send('Zoom Room Control System is not connected');
    }
    const { body: { value } } = req;
  ...
  router.post('/zconfiguration.audio.input.volume', async (req: express$Request, res: express$Response) => {
    if (!zrcs) {
      return res.status(400).send('Zoom Room Control System is not connected');
    }
    const { body: { value } } = req;
  ...
  router.post('/zconfiguration.video.camera.selectedID', async (req: express$Request, res: express$Response) => {
    if (!zrcs) {
      return res.status(400).send('Zoom Room Control System is not connected');
    }
    const { body: { value } } = req;
  ...
  router.post('/zconfiguration.video.camera.mirror', async (req: express$Request, res: express$Response) => {
    if (!zrcs) {
      return res.status(400).send('Zoom Room Control System is not connected');
    }
    const { body: { value } } = req;
  ...
  router.post('/zconfiguration.client.appVersion', async (req: express$Request, res: express$Response) => {
    if (!zrcs) {
      return res.status(400).send('Zoom Room Control System is not connected');
    }
    const { body: { value } } = req;
  ...
  router.post('/zconfiguration.client.deviceSystem', async (req: express$Request, res: express$Response) => {
    if (!zrcs) {
      return res.status(400).send('Zoom Room Control System is not connected');
    }
    const { body: { value } } = req;
