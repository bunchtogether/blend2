...
function rand {
    /usr/local/Cellar/coreutils/8.26/bin/gshuf -i $1-$2 -n 1
}
...
while true; do
    ...
    sleep 2
    sed -i.bak 's/SDP://' data.sdp

    # Sleep for 300-600 secs
    run_time=$(rand 300 600)
